...
#define EYE_TRACKING_CALIBRATION_TOLERANCE (EYE_TRACKING_CALIBRATION_CELL_RANGE_X * EYE_TRACKING_CALIBRATION_CELL_SCALE_X / (float)EYE_TRACKING_CALIBRATION_NUM_CELLS_X)
...
#define EYE_TRACKING_CALIBRATION_MAX_SAMPLES_PER_CELL 10
