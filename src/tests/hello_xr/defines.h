...
#define ENABLE_BLEND (ENABLE_TINT && 1)
#define ENABLE_CONTROLLER_MOTION_BLUR (ENABLE_BLEND && 0)
#define ENABLE_CONTROLLER_MOTION_TRAILS (ENABLE_TINT && !ENABLE_CONTROLLER_MOTION_BLUR && 0)
