...
// Controller support
#define SUPPORT_KHR_SIMPLE_CONTROLLERS 1
#define SUPPORT_TOUCH_CONTROLLERS 1
#define SUPPORT_KHR_GENERIC_CONTROLLERS 0
#define SUPPORT_VIVE_CONTROLLERS 1
#define SUPPORT_VALVE_INDEX_CONTROLLERS 1
#define SUPPORT_WMR_CONTROLLERS 1
...
#define ENABLE_GAZE_CALIBRATION 0
...
#define USE_WHITE_CUBES 1

#define DISTANCE_TO_VIEW_FRONT_METERS 2.0f

#define EYE_TRACKING_CALIBRATION_CELL_RANGE_X (DISTANCE_TO_VIEW_FRONT_METERS * 1.0f)
#define EYE_TRACKING_CALIBRATION_CELL_RANGE_Y (DISTANCE_TO_VIEW_FRONT_METERS * 1.0f)
...
#define EYE_TRACKING_CALIBRATION_NUM_CELLS_X 16
#define EYE_TRACKING_CALIBRATION_NUM_CELLS_Y 16
...
#define EYE_TRACKING_CALIBRATION_HALF_CELL_SIZE_X (EYE_TRACKING_CALIBRATION_CELL_SIZE_X / 2.0f)
#define EYE_TRACKING_CALIBRATION_HALF_CELL_SIZE_Y (EYE_TRACKING_CALIBRATION_CELL_SIZE_Y / 2.0f)

#define EYE_TRACKING_CALIBRATION_CENTER_X (EYE_TRACKING_CALIBRATION_HALF_CELL_RANGE_X - EYE_TRACKING_CALIBRATION_HALF_CELL_SIZE_X)
#define EYE_TRACKING_CALIBRATION_CENTER_Y (EYE_TRACKING_CALIBRATION_HALF_CELL_RANGE_Y - EYE_TRACKING_CALIBRATION_HALF_CELL_SIZE_Y)

#define EYE_TRACKING_CALIBRATION_CELL_SCALE_MULT_X 1.0f
#define EYE_TRACKING_CALIBRATION_CELL_SCALE_MULT_Y 1.0f
...
#define EYE_TRACKING_CALIBRATION_TOLERANCE_DIST (EYE_TRACKING_CALIBRATION_HALF_CELL_SIZE_X * 4.0f)
#define EYE_TRACKING_CALIBRATION_TOLERANCE_MAX_ERROR EYE_TRACKING_CALIBRATION_TOLERANCE_DIST
...
#define ANIMATE_CALIBRATION_CUBES_EVERY_N 1

#define DRAW_ALL_CALIBRATION_CUBES (!ANIMATE_CALIBRATION_CUBES && 0)
#define DRAW_ONLY_EVEN_CALIBRATION_CUBES 0

#define SAMPLE_GAZE_ON_PULL_TRIGGER_PULL 0

#define AUTO_CALIBRATE 1
#define AUTO_INCREMENT_COUNTDOWN 10

#define AUTO_INCREMENT_ON_CALIBRATION_DONE 0// (!AUTO_INCREMENT_ON_PULL_TRIGGER_PULL && (!ANIMATE_CALIBRATION_CUBES && !DRAW_ALL_CALIBRATION_CUBES) && 0)
#define AUTO_INCREMENT_ON_STOP_CALIBRATION 0// (!AUTO_INCREMENT_ON_PULL_TRIGGER_PULL && !AUTO_INCREMENT_ON_CALIBRATION_DONE && 0)

#define NUM_CALIBRATION_GRANULARITIES 1
#define AUTO_SAVE_CALIBRATION_WHEN_DONE 1
#define AUTO_QUIT_APP_WHEN_DONE 1
...
#define DRAW_FIRST_PERSON_EYE_LASERS (DRAW_EYE_LASERS && SUPPORT_THUMBSTICKS && 1)
#define DRAW_THIRD_PERSON_EYE_LASERS (DRAW_EYE_LASERS && SUPPORT_THIRD_PERSON && SUPPORT_THUMBSTICKS && 1)
...
#define ENABLE_VIVE_TRACKERS (PLATFORM_PC && 0)
...
#define USE_WAIST_ORIENTATION_FOR_STICK_DIRECTION (ENABLE_BODY_TRACKING && SUPPORT_THUMBSTICKS && 1)
...
#define USE_THUMBSTICKS_FOR_MOVEMENT (SUPPORT_THUMBSTICKS && 0)
...
#define SUPPORT_SMOOTH_TURNING (SUPPORT_THUMBSTICKS && 1)

#define SUPPORT_SNAP_TURNING (SUPPORT_THUMBSTICKS && 1)
...
#define DRAW_GRIP_POSE (SUPPORT_GRIP_POSE && 1)

#define SUPPORT_AIM_POSE 0
#define DRAW_AIM_POSE (SUPPORT_AIM_POSE && 1)
#define DRAW_ALL_VIVE_TRACKERS (ENABLE_VIVE_TRACKERS && 0)
...
// Draw / debug
#define DRAW_LOCAL_POSES (SUPPORT_THUMBSTICKS && 0)
#define DRAW_FIRST_PERSON_POSES (SUPPORT_THUMBSTICKS && 0)
