...
#define AUTO_INCREMENT_ON_CALIBRATION_DONE ((!ANIMATE_CALIBRATION_CUBES && !DRAW_ALL_CALIBRATION_CUBES) && 0)
#define AUTO_INCREMENT_ON_STOP_CALIBRATION (!AUTO_INCREMENT_ON_CALIBRATION_DONE && 1)
