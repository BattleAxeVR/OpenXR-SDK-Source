...
#define DISTANCE_TO_VIEW_FRONT_METERS 10.0f
...
#define EYE_TRACKING_CALIBRATION_NUM_CELLS_X 5
#define EYE_TRACKING_CALIBRATION_NUM_CELLS_Y 5
...
#define EYE_TRACKING_CALIBRATION_TOLERANCE_DEG 20.0f
#define EYE_TRACKING_CALIBRATION_TOLERANCE_DIST (EYE_TRACKING_CALIBRATION_HALF_CELL_SIZE_X * 0.1f)
#define EYE_TRACKING_CALIBRATION_TOLERANCE_MAX_ERROR EYE_TRACKING_CALIBRATION_TOLERANCE_DIST

#define EYE_TRACKING_CALIBRATION_IN_CARTESIAN_COORDS 1
...
#define SAMPLE_GAZE_ON_PULL_TRIGGER_PULL 1
#define AUTO_INCREMENT_ON_PULL_TRIGGER_PULL (SAMPLE_GAZE_ON_PULL_TRIGGER_PULL && 1)
#define AUTO_INCREMENT_ON_PULL_TRIGGER_PULL_COUNTDOWN 90

#define AUTO_INCREMENT_ON_CALIBRATION_DONE (!AUTO_INCREMENT_ON_PULL_TRIGGER_PULL && (!ANIMATE_CALIBRATION_CUBES && !DRAW_ALL_CALIBRATION_CUBES) && 0)
#define AUTO_INCREMENT_ON_STOP_CALIBRATION (!AUTO_INCREMENT_ON_PULL_TRIGGER_PULL && !AUTO_INCREMENT_ON_CALIBRATION_DONE && 0)
