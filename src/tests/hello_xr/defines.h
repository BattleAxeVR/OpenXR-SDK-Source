...
#define MAX_MOTION_BLUR_STEPS 200
#define MODULATE_BLUR_STEPS_WITH_GRIP_VALUE 0
#define MODULATE_ALPHA_BASE_WITH_GRIP_VALUE 1
#define DEBUG_LOG_ALPHA_VALUES 0
#define ALPHA_BASE 0.85f
#define ALPHA_MULT 0.5f
#define NORMALIZE_ALPHA 0
