...
#define ENABLE_PSVR2_EYE_TRACKING_CALIBRATION ((ENABLE_PSVR2_EYE_TRACKING_COMBINED_GAZE || ENABLE_PSVR2_EYE_TRACKING_PER_EYE_GAZES) && 0)
...
#define CALIBRATION_CUBE_SIZE 0.05f
...
#define EYE_LASER_WIDTH 0.01f
#define EYE_LASER_DISTANCE_OFFSET 0.2f
