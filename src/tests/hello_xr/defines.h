...
#define ENABLE_PSVR2_EYE_TRACKING_CALIBRATION_HARDCODED (ENABLE_PSVR2_EYE_TRACKING_CALIBRATION && 0)
#define ENABLE_PSVR2_EYE_TRACKING_CALIBRATION_RASTER_SCAN (ENABLE_PSVR2_EYE_TRACKING_CALIBRATION && !ENABLE_PSVR2_EYE_TRACKING_CALIBRATION_HARDCODED && 1)

#define OFFSET_GAZES_BY_THUMBSTICK (ENABLE_PSVR2_EYE_TRACKING && 0)
#define OFFSET_GAZES_BY_THUMBSTICK_RANGE_DEG 20.0f

#define EYE_TRACKING_CALIBRATION_MAX_DEGREES 45.0f

#define EYE_TRACKING_CALIBRATION_NUM_CELLS_X 11
#define EYE_TRACKING_CALIBRATION_NUM_CELLS_Y 11
...
#define TOGGLE_APPLY_CALIBRATION (ENABLE_PSVR2_EYE_TRACKING_CALIBRATION && 1)
