...
#define EYE_TRACKING_CALIBRATION_CELL_SCALE 0.1f
...
#define EYE_TRACKING_CALIBRATION_TOTAL_DEGREES_X 90.0f
#define EYE_TRACKING_CALIBRATION_TOTAL_DEGREES_Y 90.0f

#define EYE_TRACKING_CALIBRATION_HALF_DEGREES_X (EYE_TRACKING_CALIBRATION_TOTAL_DEGREES_X / 2.0f)
#define EYE_TRACKING_CALIBRATION_HALF_DEGREES_Y (EYE_TRACKING_CALIBRATION_TOTAL_DEGREES_Y / 2.0f)

#define EYE_TRACKING_CALIBRATION_NUM_DEGREES_PER_CELL_X (EYE_TRACKING_CALIBRATION_TOTAL_DEGREES_X / (float)EYE_TRACKING_CALIBRATION_NUM_CELLS_X)
#define EYE_TRACKING_CALIBRATION_NUM_DEGREES_PER_CELL_Y (EYE_TRACKING_CALIBRATION_TOTAL_DEGREES_Y / (float)EYE_TRACKING_CALIBRATION_NUM_CELLS_Y)

#define EYE_TRACKING_CALIBRATION_CELLS_PER_DEGREE_X (EYE_TRACKING_CALIBRATION_NUM_CELLS_X / (float)EYE_TRACKING_CALIBRATION_TOTAL_DEGREES_X)
#define EYE_TRACKING_CALIBRATION_CELLS_PER_DEGREE_Y (EYE_TRACKING_CALIBRATION_NUM_CELLS_Y / (float)EYE_TRACKING_CALIBRATION_TOTAL_DEGREES_Y)
...
#define DRAW_VIEW_SPACE 0
#define DRAW_EXTRA_VIEW_CUBES 0
#define ANIMATE_VIEW_RASTER_CUBES 1
#define ANIMATE_VIEW_RASTER_CUBES_EVERY_N 180
