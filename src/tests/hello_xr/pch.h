...
#define DRAW_WORLD_EYE_LASERS (ENABLE_EYE_TRACKING && USE_THUMBSTICKS_FOR_SMOOTH_LOCOMOTION && 0)
...
#define DRAW_LOCAL_WAIST_DIRECTION (USE_WAIST_ORIENTATION_FOR_STICK_DIRECTION && 1)
...
#define PREFER_SNAP_TURNING (USE_THUMBSTICKS_FOR_SMOOTH_LOCOMOTION && 0)
