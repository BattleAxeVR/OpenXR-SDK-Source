...
#define CEILING_HEIGHT_METERS 4.0f
...
#define SUPPORT_SNAP_TURNING (USE_THUMBSTICKS && 0)
#define PREFER_SNAP_TURNING (SUPPORT_SNAP_TURNING && (!SUPPORT_SMOOTH_TURNING || 1))
...
#define RUNNING_SPEED_BOOST 0.06f

#define SMOOTH_TURNING_ROTATION_SPEED 1.0f
#define ROTATION_SPEED_EXTRA 5.0f
